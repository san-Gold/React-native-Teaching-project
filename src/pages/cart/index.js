...
export default class ShoppingCart extends Component {
  ...
  checkAllShop() {
    ...
    this.calculateCountAndPrice();
    this.setState({
      isSelectedAllItem: tempSelectedAllItem,
      status: tempStatus,
    });
  }
      ...
      <View style={styles.cellStyle}>
        <TouchableOpacity onPress={() => this.checkItem(sectionIndex, index)}>
          <Image
            ...
            source={
              statusItem.checked
                ? require("../../assets/ic_selected.png")
                : require("../../assets/ic_defult.png")
            }
            resizeMode={"center"}
          />
        </TouchableOpacity>
        ...
        >
          <Text style={{ fontSize: 13, color: commonStyle.textBlockColor }}>
            {item.itemName}
          </Text>
          <Text
            style={{ fontSize: 13, color: commonStyle.textBlockColor }}
          >{`￥${item.itemPrice}`}</Text>
        </View>
        <View
          style={{
        ...
        >
          <TouchableOpacity
            style={styles.checkNum}
            onPress={() => this.minus(sectionIndex, index)}
          >
            <Image
              style={styles.checkNumImage}
          ...
          <TouchableOpacity
            style={styles.checkNum}
            onPress={() => this.add(sectionIndex, index)}
          >
            <Image
              style={styles.checkNumImage}
